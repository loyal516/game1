    ...
    public static class LocalRosterBuilder
    {
        ...
        public static LocalRosterSlot[] CreateDefaultThreeVsThree()
        {
            return new[]
            {
                ...
                new LocalRosterSlot("Red Rival 1", TeamId.Red, 1, new Vector3(2.8f, 1f, -3.8f), false),
                new LocalRosterSlot("Red Rival 2", TeamId.Red, 2, new Vector3(5.1f, 1f, -2.2f), false),
                new LocalRosterSlot("Red Rival 3", TeamId.Red, 3, new Vector3(0.6f, 1f, -2.2f), false)
            };
        }
