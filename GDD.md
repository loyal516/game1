...
|----------|------|-----------|-------------|
| P0 | 팀 상태 아이콘 아트 | 상태별 아이콘이 텍스트 없이도 구분되고, 색각 모드에서도 의미가 유지됨 | 임시 텍스트/색상 의존 제거 필요 |
