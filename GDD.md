...
| 점령/승리 시스템 | 부분 완료 | 로컬 CapturePoint 3개, 반경 5m, 팀별 인원 집계, 1명 5%/초·2명 8%/초·3명+ 12%/초, 경합 정지, 빈 미완료 포인트 3%/초 decay, Attacker/King 자동 부여, 3점 점령 30초 승리 카운트다운, 상대 팀 전원 Captured 즉시 승리, `LocalMatchPhase` Playing/VictoryCountdown/Result, defender re-entry window, 카운트다운 시작/중단/종료 `LocalMatchFlowEvent`, HUD phase/defender 표시, `LocalMatchFlowPresenter` 배너/overlay/defender re-entry spawn/임시 Attacker 버프, EditMode 테스트 | 시간 종료 생존 승리, 포기 처리, 정식 카메라 컷인, 공수전환 사운드/아트 polish, 네트워크 권위화 |
